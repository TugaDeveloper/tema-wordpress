...
// Variáveis para widgets
 class MediaWidget extends WP_Widget{
    ...
    public function __construct(){
        ...
        $this->widget_ID = 'goweb_media_widget';

        $this->widget_name = 'Goweb Widgets';
    ...
    public function widget($args, $instance){
        ...
        if(! empty($instance['image'])){
            ...
            echo '<img src="' . esc_url($instance) . '" alt="">';
    ...
    public function form( $instance ) {
        ...
        <p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>"><?php esc_attr_e( 'Imagem:', 'awps' ); ?></label> 
        ...
        <button type="button" class="button button-primary js-image-upload">Selecionar Imagem</button>
		</p>
