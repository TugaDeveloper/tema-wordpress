...
class CustomTaxonomyController extends BaseController{
	...
	public function setSettings(){
		$args = array(
			array(
				'option_group' => 'goweb_plugin_tax_settings',
				'option_name' => 'goweb_plugin_tax',
	...
	public function setSections(){
		$args = array(
			array(
				'id' => 'goweb_tax_index',
				'title' => 'Gestor de taxonomias personalizadas',
	...
	public function setFields(){
		$args = array(
			array(
				'id' => 'taxonomy',
				'title' => 'ID da taxonomia',
				'callback' => array($this->tax_callbacks, 'textField'),
				'page' => 'goweb_taxonomy',
				'section' => 'goweb_tax_index',
				'args' => array(
					'option_name' => 'goweb_plugin_tax',
					'label_for' => 'taxonomy',
					'placeholder' => 'Taxonomia',
					'array' => 'taxonomy'
				)
			),
			...
			array(
				'id' => 'singular_name',
				'title' => 'Nome Singular / Individual',
				'callback' => array( $this->tax_callbacks, 'textField' ),
				'page' => 'goweb_taxonomy',
				'section' => 'goweb_tax_index',
				'args' => array(
