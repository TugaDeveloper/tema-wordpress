  ...
  */
  ...
  class CustomPostTypeController extends BaseController{
      ...
      public function setSubpages(){
		$this->subpages = array(
			array(
				...
				'menu_title' => 'Posts Personalizados', 
    ...
    public function setSettings(){
      ...
      $args = array(array(
        'option_group' => 'goweb_plugin_cpt_settings',
  ...
  public function setSections()
	{
		$args = array(
			array(
				'id' => 'goweb_cpt_index',
				'title' => 'Gestão de posts personalizados.',
  ...
  public function setFields(){
    ...
    // has_archive
      $args = array(
        array(
          'id' => 'post_type',
          'title' => 'ID do Post Personalizado',
          'callback' => array( $this->cpt_callbacks, 'textField' ),
          'page' => 'goweb_cpt',
          'section' => 'goweb_cpt_index',
          'args' => array(
            'option_name' => 'goweb_plugin_cpt',
            'label_for' => 'post_type',
						'placeholder' => 'ID',
