document.addEventListener('DOMContentLoaded', function (e) {
    const showAuthBtn = document.getElementById('goweb-show-auth-form'),
        authContainer = document.getElementById('goweb-auth-container'),
        close = document.getElementById('goweb-auth-close'),
        authForm = document.getElementById('goweb-auth-form'),
    ...
    authForm.addEventListener('submit', e => {
        ...
        let data = {
            ...
            nonce: authForm.querySelector('[name="goweb_auth"]').value
        }
